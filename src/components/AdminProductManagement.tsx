    ...
    <div className="space-y-4">
      ...
      {selectedIds.size > 0 && (
        <div className="flex items-center gap-3 p-3 bg-primary/10 border border-primary/20 rounded-xl">
          ...
          <Button size="sm" variant="outline" className="border-border text-foreground h-8" onClick={() => bulkToggleStock(true)}>
            Mark In Stock
          </Button>
          <Button size="sm" variant="outline" className="border-border text-foreground h-8" onClick={() => bulkToggleStock(false)}>
            Mark Out of Stock
          </Button>
          <Select onValueChange={bulkChangeCategory}>
            <SelectTrigger className="bg-card border-border text-foreground w-40 h-8 text-sm">
          ...
          <Button size="sm" variant="destructive" className="h-8 ml-auto" onClick={bulkDelete}>
      ...
      {filteredProducts.length === 0 ? (
        ...
        <div className="bg-card/30 rounded-xl border border-border overflow-hidden">
          ...
          {filteredProducts.map((product, index) => (
            <div
              key={product.id}
              className={`grid md:grid-cols-[40px_80px_1fr_130px_110px_90px_80px_100px] gap-3 p-3 items-center hover:bg-muted/10 transition-colors ${
            ...
            >
              ...
              <div className="flex items-center gap-1">
                {editingPriceId === product.id ? (
                  ...
                  <button
                    ...
                    className="flex items-center gap-0.5 px-2 py-1 bg-primary/10 hover:bg-primary/20 text-primary rounded-md transition-colors group text-sm"
                  >
              ...
              <div className="flex items-center justify-end gap-1.5">
                <Button
                  ...
                  className="border-border text-foreground hover:bg-muted h-7 w-7 p-0"
                >

    ...
    <section className="relative min-h-[90vh] lg:min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-20">
        <div className="max-w-4xl">
          {/* Badge */}
          <div className="mb-8">
            <div className="inline-flex items-center gap-2 sm:gap-4 px-4 sm:px-6 py-2.5 sm:py-3 rounded-full border border-primary/30 bg-gradient-to-r from-primary/20 via-charcoal/80 to-primary/20 backdrop-blur-md shadow-[0_0_30px_rgba(212,175,55,0.3)] hover:shadow-[0_0_40px_rgba(212,175,55,0.5)] transition-all duration-500 group">
